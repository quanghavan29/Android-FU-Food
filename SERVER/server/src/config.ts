...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'isc301';
    ...
    'jhipster.mail.from' = 'isc301@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'isc301 API';
    'jhipster.swagger.description' = 'isc301 API documentation';
    ...
    'eureka.instance.appname' = 'isc301';
    'eureka.instance.instanceId' = 'isc301:${random.value}';
