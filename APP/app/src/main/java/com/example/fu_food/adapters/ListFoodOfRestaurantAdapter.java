...
public class ListFoodOfRestaurantAdapter extends RecyclerView.Adapter<ListFoodOfRestaurantAdapter.ListFoodOfRestaurantViewHolder> {

    public static Context context;
    public static List<Food> foods;

    public ListFoodOfRestaurantAdapter(Context context, List<Food> foods) {
    ...
    @NonNull
    @Override
    public ListFoodOfRestaurantViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_food_of_restaurant_holder, parent, false);
        return new ListFoodOfRestaurantAdapter.ListFoodOfRestaurantViewHolder(view);
    }
    ...
    public static class ListFoodOfRestaurantViewHolder extends RecyclerView.ViewHolder {
        ...
        public ListFoodOfRestaurantViewHolder(@NonNull View itemView) {
            super(itemView);
